...
/** generateKeys POST /api/user/generate/keys */
export async function generateKeysUsingPOST(options?: { [key: string]: any }) {
  return request<API.BaseResponseKeyInfo>('/api/user/generate/keys', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** regenerateKeys POST /api/user/regenerate/keys */
export async function regenerateKeysUsingPOST(options?: { [key: string]: any }) {
  return request<API.BaseResponseKeyInfo>('/api/user/regenerate/keys', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** getKeys GET /api/user/get/keys */
export async function getKeysUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseKeyInfo>('/api/user/get/keys', {
    method: 'GET',
    ...(options || {}),
  });
}
